"""Interactively align mean-shape meshes to the centered MS leaflet surfaces."""
...
from surface_mesh_analysis.mesh_utils import read_polydata, write_polydata


def plot_meshes(mesh1, mesh2, color1=(1,0,0), color2=(0,1,0), opacity1=0.5, opacity2=0.5):
    """Visualize aligned and target meshes with axes and a legend."""
    ...
    legend.GetPositionCoordinate().SetValue(0.7, 0.05)
...
def rotate_polydata(polydata, angle_x=0, angle_y=0, angle_z=0):
    """Rotate polydata around the X, Y, and Z axes by degrees."""
...
def align(input_file, target_file, output_file, angle_x=0, angle_y=0, angle_z=0):
    """Rotate a mean shape, rigidly align it to a target mesh, and write the result."""
...
if __name__ == "__main__":
    ...
    for leaflet in LEAFLETS:
        source_path = f"mean_shape/{leaflet}_mean_shape.vtk"
