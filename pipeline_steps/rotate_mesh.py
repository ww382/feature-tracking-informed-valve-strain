"""Check and correct MD/MS leaflet orientation before registration."""
...
from surface_mesh_analysis.mesh_utils import center_polydata_at_origin, compute_average_cell_normal, read_polydata, write_polydata
...
def plot_meshes(mesh1, mesh2, color1=(1,0,0), color2=(0,1,0)):
    ...
    def create_arrow_actor(centroid, normal, color):
        """Create an arrow actor aligned with a mesh normal."""
        ...
        # VTK arrows point along +X by default.
        transform = vtk.vtkTransform()
...
def check_mesh(source_filepath, target_filepath, output_filepath):
    """Flip and recenter a source mesh when its normal opposes the target normal."""
